    ...
    <div class="container  " style="margin-top: 10%; ">
        <div class="row " >
            <div class="main first col-lg-3  ">
                <div class="card" style="width: 16rem; height: 15rem; border-radius: 20px;">
                    ...
                    <img src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}"
                        style="height: 7rem; border-top-right-radius: 20px; border-top-left-radius: 20px;">
                ...
                <div class="bg-light pt-4" style="width: 16rem;">
                    <div class="Post bg-white border-gray">
                        <div class="add ">
                            ...
                            <a href="/myposts" style="color: rgb(27, 140, 216)"> <span>My Posts</span></a>
                        </div>
                        <div class="add">
                            <svg class="svg-color" xmlns="http://www.w3.org/2000/svg" height="24"
                                viewBox="0 -960 960 960" width="24" fill="currentColor">
                           ...
                           <a href="/myfriends" style="color:  rgb(27, 140, 216)"> <span>My Friends</span></a>
                        </div>
            ...
            <div class=" center col-lg-6 ">
                ...
                <div class="post bg-white border-gray mt-3">
                    ...
                    <div class="post-title pt-2 d-flex justify-content-between">
                        <div class="d-flex">
                            <img class="post-profile rounded-circle" src="{{ Storage::url($user->profile_photo_path) }} ">
                    ...
                    <div class="col">
                      <div style="font-size: 11px; display:flex; margin: 5px">
                        <h6 style=" font-size:12px"> Share</h6><h6> {!!$shareComponent!!}</h6><h6 style=" font-size:12px">Quick Reply<i class="fa-solid fa-reply-all" style="height: 20px;width:20px; color:rgb(68, 163, 252)"></i></h6><h5 style="color: rgb(25, 157, 239)"><i class="fa-regular fa-thumbs-up"></i></h5>
            ...
            <div class=" main last col-3 ">
                        ...
                        <div class="row">
                            ...
                            <a href="{{ url('sendrequest',$user->id) }}"><button id="regiscss" style=" width:100%;font-size:11px; color:rgb(255, 255, 255);border:1px solid rgb(27, 140, 216)" type="submit" class="btn  btn-sm fw-bold">+Add</button>
                             ...
                             {{-- <div class="col-md-2 mt-0">
                                <a href="{{ url('deleterequest',$user->id) }}">   <button  style="font-size: 11px;color:rgb(27, 140, 216)" type="submit" class="btn btn-outline-info btn-sm fw-bold">Remove</button>
                                </a> 
                                 </div> --}}
                ...
                <div class="mt-4" style="width: 25rem;margin-left:-28px  ">
                    <div class="recent-posts" style="padding: 12px; background-color:transparent; text-align:center ">
                      ...
                      <div class="row justify-content-center d-flex" style=" font-size: 9px; margin-top:-5; margin-left:-34%">
                          ...
                          <div class="col-md-2">
                              <ul class="list-unstyled">
                                 <a style="color: #0c0c0c" href="/view_contact"><li>Contact Us</li></a> 
                              </ul>
                          </div>
                      </div>
